...
public class QnineActivity extends AppCompatActivity {
    ...
    public void click(View view){
            ...
            String Q9 = rb.getText().toString();


            Intent intent = new Intent(this, QtenActivity.class);
            /////re
            ...
            String TAG = "chose:";
            Log.d(TAG, Q1 + ";" + Q2 + ";" + Q3 + ";" + Q4 + ";" + Q5 + ";" + Q6 + ";" + Q7 + ";" + Q8 + ";" + Q9);
