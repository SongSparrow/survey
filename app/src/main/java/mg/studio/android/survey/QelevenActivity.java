...
public class QelevenActivity extends AppCompatActivity {
    ...
    public void click(View view){
            ...
            String Q11 = rb.getText().toString();


            Intent intent = new Intent(this, QtwelveActivity.class);
            /////re
